 ...
 * @author user
 */
public class FramePeminjam extends javax.swing.JFrame {
    Connection connection;
    DefaultTableModel model;
    /**
     * Creates new form FramePeminjam
     */
        ...
        if(!tCari.getText().trim().isEmpty()) {
            ...
            cari();
                ...
                JOptionPane.showMessageDialog(this, 
                        "Masukkan nama peminjam yang ingin dicari!",
    ...
    if (selectedRow != -1) {
        ...
        int alert = JOptionPane.showConfirmDialog(this, "Anda yakin ingin menghapus pesan ini?",
                "Notifikasi", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);

        if (alert == JOptionPane.YES_OPTION) {
            // User clicked Yes, proceed with deletion
            hapus(); // You need to implement the 'hapus()' method
            refresh(); // You need to implement the 'refresh()' method
...
int selectedRow = Tabel.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FramePeminjam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
