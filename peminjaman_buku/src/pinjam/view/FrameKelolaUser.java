 ...
 * @author User
 */
public class FrameKelolaUser extends javax.swing.JFrame {
    Connection connection;
    DefaultTableModel model;
    /**
     * Creates new form FrameKelolaUser
     */
    public FrameKelolaUser() {
        initComponents();
    ...
    private void simpan() {
        PreparedStatement statement = null;
        String sql = "INSERT INTO tbluser (id_user,username,password,alamat,no_telp,email) VALUES(?,?,?,?,?,?);";
                try {
                    statement = connection.prepareStatement(sql,
                    Statement.RETURN_GENERATED_KEYS);
                    statement.setString(1, tIDUser.getText());
    ...
    private void hapus(){
        PreparedStatement statement = null;
        String sql = "DELETE FROM tbluser WHERE id_user=?";
                try {
                    statement = connection.prepareStatement(sql);
                    statement.setString(1, tIDUser.getText());
                    statement.executeUpdate();
    ...
    private void ubah() {
        ...
        String sql = "UPDATE tbluser SET "
                + "username=?,password=?,alamat=?,no_telp=?,email=? "
                + "WHERE id_user=? ";
                try {
                    statement = connection.prepareStatement(sql,
                            Statement.RETURN_GENERATED_KEYS);
                    ...
                    statement.setString(6, tIDUser.getText());
                    statement.executeUpdate();
                } catch (SQLException ex) {
                    ex.printStackTrace();
                } finally {
    ...
    private void initComponents() {
        ...
        Tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_user", "Username", "Password", "Alamat", "No Telp", "Email"
            }
        ));
        ...
        jLabel8.setText("Cari Nama User :");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tIDUser, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void TabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelMouseClicked
        ...
        tIDUser.setText(Tabel.getModel().getValueAt
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        // TODO add your handling code here:
        if(!tIDUser.getText().trim().isEmpty()
            ...
            refresh();
            reset();
            JOptionPane.showMessageDialog(this, "User Baerhasil ditambahkan",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameKelolaUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
